...
public class RxMatchGroup  implements java.io.Serializable {
    ...
    private edu.phema.rxnorm.BeanService.RxMatchInfo[] rxMatchInfo;
    ...
    public RxMatchGroup(
           ...
           edu.phema.rxnorm.BeanService.RxMatchInfo[] rxMatchInfo) {
     ...
     * @return rxMatchInfo
     */
    public edu.phema.rxnorm.BeanService.RxMatchInfo[] getRxMatchInfo() {
        return rxMatchInfo;
    }
     ...
     * @param rxMatchInfo
     */
    public void setRxMatchInfo(edu.phema.rxnorm.BeanService.RxMatchInfo[] rxMatchInfo) {
        this.rxMatchInfo = rxMatchInfo;
    }
