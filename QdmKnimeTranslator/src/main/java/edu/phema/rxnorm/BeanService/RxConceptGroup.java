...
public class RxConceptGroup  implements java.io.Serializable {
    private edu.phema.rxnorm.BeanService.RxConcept[] rxConcept;
    ...
    public RxConceptGroup(
           edu.phema.rxnorm.BeanService.RxConcept[] rxConcept,
     ...
     * @return rxConcept
     */
    public edu.phema.rxnorm.BeanService.RxConcept[] getRxConcept() {
        return rxConcept;
    }
     ...
     * @param rxConcept
     */
    public void setRxConcept(edu.phema.rxnorm.BeanService.RxConcept[] rxConcept) {
        this.rxConcept = rxConcept;
    }
