...
public class RxTree  implements java.io.Serializable {
    private edu.phema.rxnorm.BeanService.RxEdge[] rxEdge;

    private edu.phema.rxnorm.BeanService.RxNode[] rxNode;
    ...
    public RxTree(
           edu.phema.rxnorm.BeanService.RxEdge[] rxEdge,
           edu.phema.rxnorm.BeanService.RxNode[] rxNode,
     ...
     * @return rxEdge
     */
    public edu.phema.rxnorm.BeanService.RxEdge[] getRxEdge() {
        return rxEdge;
    }
     ...
     * @param rxEdge
     */
    public void setRxEdge(edu.phema.rxnorm.BeanService.RxEdge[] rxEdge) {
        this.rxEdge = rxEdge;
    }
     ...
     * @return rxNode
     */
    public edu.phema.rxnorm.BeanService.RxNode[] getRxNode() {
        return rxNode;
    }
     ...
     * @param rxNode
     */
    public void setRxNode(edu.phema.rxnorm.BeanService.RxNode[] rxNode) {
        this.rxNode = rxNode;
    }
