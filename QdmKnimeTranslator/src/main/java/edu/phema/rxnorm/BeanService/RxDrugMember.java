...
package edu.phema.rxnorm.BeanService;

public class RxDrugMember  implements java.io.Serializable {
    private edu.phema.rxnorm.BeanService.AttributeGroup[] attributes;

    private edu.phema.rxnorm.BeanService.RxMinimalConcept rxMinimalConcept;

    public RxDrugMember() {
    }

    public RxDrugMember(
           edu.phema.rxnorm.BeanService.AttributeGroup[] attributes,
           edu.phema.rxnorm.BeanService.RxMinimalConcept rxMinimalConcept) {
     ...
     * @return attributes
     */
    public edu.phema.rxnorm.BeanService.AttributeGroup[] getAttributes() {
        return attributes;
    }
     ...
     * @param attributes
     */
    public void setAttributes(edu.phema.rxnorm.BeanService.AttributeGroup[] attributes) {
        this.attributes = attributes;
    }
     ...
     */
    public edu.phema.rxnorm.BeanService.RxMinimalConcept getRxMinimalConcept() {
        return rxMinimalConcept;
    }
     ...
     */
    public void setRxMinimalConcept(edu.phema.rxnorm.BeanService.RxMinimalConcept rxMinimalConcept) {
        this.rxMinimalConcept = rxMinimalConcept;
    }
