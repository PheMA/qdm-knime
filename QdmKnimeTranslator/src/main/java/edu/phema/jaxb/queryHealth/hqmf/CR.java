...
/**
 *  A concept qualifier code with optionally named role. Both qualifier role
 *         and value codes must be defined by the coding system. For example, if SNOMED RT defines a
 *         concept "leg", a role relation "has-laterality", and another concept "left", the concept
 *         role relation allows to add the qualifier "has-laterality: left" to a primary code "leg" to
 *         construct the meaning "left leg". 
 * 
