 ...
 *         object identifier for HL7 RIM objects, medical record number, order id, service catalog item
 *         id, Vehicle Identification Number (VIN), etc. Instance identifiers are defined based on ISO
 *         object identifiers. 
 * 
