 ...
 *         parts, such as given name or family name, prefix, suffix, etc. Examples for entity name
 *         values are "Jim Bob Walton, Jr.", "Health Level Seven, Inc.", "Lake Tahoe", etc. An entity
 *         name may be as simple as a character string or may consist of several entity name parts,
 *         such as, "Jim", "Bob", "Walton", and "Jr.", "Health Level Seven" and "Inc.", "Lake" and
 *         "Tahoe". 
 * 
