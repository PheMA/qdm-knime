...
/**
 *  A character string token representing a part of a name. May have a type
 *         code signifying the role of the part in the whole entity name, and a qualifier code for more
 *         detail about the name part type. Typical name parts for person names are given names, and
