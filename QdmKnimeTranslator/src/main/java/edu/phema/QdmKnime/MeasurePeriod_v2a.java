...
import edu.phema.QdmKnimeInterfaces.MeasurePeriodInterface_v2a;
 ...
 *
 */
public class MeasurePeriod_v2a extends MetaNode implements MeasurePeriodInterface_v2a {
...
//	}
	...
	public MeasurePeriod_v2a(String start_yyyyMMddHHmm, String end_yyyyMMddHHmm) throws ParseException{
	...
	public void write() throws WrittenAlreadyException,
		...
		String zipFileName = "MeasurePeriod_v2a.zip";
		String inZipFolderName = "MeasurePeriod_v2a";
		...
		/*
		 * TODO adapt to the new MeasurePeriod_v2a
		 * 
		 * Start and End are separated to two nodes
		 * 
		 * */
