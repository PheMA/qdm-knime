...
public class DBManagerServiceLocator extends org.apache.axis.client.Service implements gov.nih.nlm.mor.axis.services.RxNormDBService.DBManagerService {
    ...
    private java.lang.String RxNormDBService_address = "http://mor.nlm.nih.gov/axis/services/RxNormDBService";
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://mor.nlm.nih.gov/axis/services/RxNormDBService", "DBManagerService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://mor.nlm.nih.gov/axis/services/RxNormDBService", "RxNormDBService"));
        }
